...
namespace Challenge.Infrastructure.CrossCutting.ActionResults
{
    ...
    public class ActionResult<TResult> : ActionResult
    {
        ...
        public new static ActionResult<TResult> CreateFailure(string nonSuccessMessage, HttpStatusCode statusCode = HttpStatusCode.InternalServerError)
        {
            return new ActionFailureResult<TResult> { Success = false, Message = nonSuccessMessage, StatusCode = statusCode };
        }

        public new static ActionResult<TResult> CreateFailure(Exception ex, HttpStatusCode statusCode = HttpStatusCode.InternalServerError)
        {
